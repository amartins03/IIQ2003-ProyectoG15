...
* Para los bloques de discretización, el código usualmente tardará desde 4 a 50 minutos en devolver resultados en la consola, dependiendo de la complejidad del algoritmo.
